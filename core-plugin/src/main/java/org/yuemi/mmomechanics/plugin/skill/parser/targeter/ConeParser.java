...
import org.yuemi.mmomechanics.plugin.skill.targeter.location.multi.ConeTargeter;

public final class ConeParser {
            ...
            for (String pair : options.split(",")) {
                ...
                if (parts.length == 2) {
                    ...
                    switch (key) {
                        ...
                        case "points" -> points = val;
                    }
                }
            }
        }
        return new ConeTargeter(angle, length, points);
    }
}
