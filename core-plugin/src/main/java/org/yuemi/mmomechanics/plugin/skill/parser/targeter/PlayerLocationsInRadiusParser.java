...
import org.yuemi.mmomechanics.plugin.skill.targeter.location.multi.PlayerLocationsInRadiusTargeter;

public final class PlayerLocationsInRadiusParser {
    public @Nullable Targeter parse(@Nullable String name) {
        ...
        return new PlayerLocationsInRadiusTargeter(radius);
    }
}
