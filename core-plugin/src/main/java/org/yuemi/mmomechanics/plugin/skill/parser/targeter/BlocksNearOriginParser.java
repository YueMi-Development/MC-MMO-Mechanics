...
import org.yuemi.mmomechanics.plugin.skill.targeter.location.multi.BlocksNearOriginTargeter;

public final class BlocksNearOriginParser {
    public @Nullable Targeter parse(@Nullable String name) {
        ...
        return new BlocksNearOriginTargeter(radius);
    }
}
