...
import org.yuemi.mmomechanics.plugin.skill.targeter.entity.multi.NotLivingNearOriginTargeter;

public final class NotLivingNearOriginParser {
    public @Nullable Targeter parse(@Nullable String name) {
        ...
        return new NotLivingNearOriginTargeter(radius);
    }
}
