...
import org.yuemi.mmomechanics.plugin.skill.targeter.entity.multi.EntitiesInRadiusTargeter;

public final class EntitiesInRadiusParser {
    public @Nullable Targeter parse(@Nullable String name) {
        ...
        return new EntitiesInRadiusTargeter(radius);
    }
}
