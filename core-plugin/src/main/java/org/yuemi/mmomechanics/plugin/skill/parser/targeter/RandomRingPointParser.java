...
import org.yuemi.mmomechanics.plugin.skill.targeter.location.multi.RandomRingPointTargeter;

public final class RandomRingPointParser {
    public @Nullable Targeter parse(@Nullable String name) {
        ...
        return new RandomRingPointTargeter(radius, amount);
    }
}
